  ...
  <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
    ...
    <div>
      <form class="flex items-center">
        ...
        <button
          ...
          class="p-2.5 ml-4 text-sm font-medium text-black bg-black-700 rounded-lg border border-white-700 hover:bg-sky-600 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-sky-500 dark:hover:bg-sky-500 dark:focus:ring-sky-600"
        >
          <svg
            class="w-5 h-5"
            fill="none"
    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      <tbody v-for="order in orders" :key="order.transactionId">
        <tr
          class="bg-white border-b dark:bg-zinc-50 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
        >
          <td class="p-4 w-32">
            <img :src="order.product.image" alt="image" />
          </td>
