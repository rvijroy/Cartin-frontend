            ...
            <div class="-space-y-px rounded-md shadow-sm">
              ...
              <div>
                <label
                  for="q"
                  class="block text-sm font-medium text-gray-700 pt-4 pb-3"
                  >Quantity (Old: {{ oldProduct.quantity }})</label
                >
                <input
              ...
              <div>
                <label
                  for="q"
                  class="block text-sm font-medium text-gray-700 pt-4 pb-3"
                  >Category (Old: {{ oldProduct.category }})</label
                >
                <select
              ...
              <div>
                <label
                  for="address"
                  class="block text-sm font-medium text-gray-700 pt-4 pb-3"
                  >Delivery time (Old: {{ oldProduct.deliveryTime }})</label
                >
                <input
...
export default {
  ...
  methods: {
    ...
    addProduct() {
      axios
        .post("http://localhost:8080/admin/updateProduct", {
    ...
    // saveImage(id) {
    //   axios
    //     .post("http://localhost:8080/manager/saveImage", {
    //       productId: id,
    //       file: this.image,
