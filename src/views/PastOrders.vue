  ...
  <div class="overflow-x-auto relative shadow-md sm:rounded-lg">
    ...
    >
      <button
        type="button"
        @click="OrderPopUp()"
        class="focus:outline-none text-white bg-sky-500 hover:bg-sky-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 mb-2 py-2.5 dark:bg-blue-600 dark:hover:bg-sky-500 dark:focus:ring-blue-900"
      >
