<template>
    ...
    <div class="border-t border-gray-200">
      <dl>
        ...
        <div class="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
          ...
          <div v-if="edit" class="opacity-25 fixed inset-0 z-40 bg-black"></div>
        </div>
      </dl>
    </div>
  </div>
  ...
  >
    <button
      @click="applyManager"
      type="button"
      class="focus:outline-none text-white bg-sky-500 hover:bg-sky-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-sky-500 dark:focus:ring-blue-900 right-20"
    >
      Apply as manager
    </button>
  </div>
