    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
      <div class="relative flex h-16 items-center justify-between">
        ...
        >
          ...
          <div class="hidden sm:ml-6 sm:block">
            <div class="flex space-x-4">
              <h2 class="pt-1 text-black">Welcome to Cartin</h2>
        ...
        <form @submit="onSearch" class="flex items-center">
          ...
          <button
            type="submit"
            class="p-2.5 ml-2 text-sm font-medium text-black hover:text-white bg-black-700 rounded-lg border border-white-700 hover:bg-sky-500 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-sky-500 dark:focus:ring-sky-600"
          >
            <svg
              class="w-5 h-5"
              fill="none"
        ...
        >
          <!-- <button
						@click="showCart"
						type="button"
						class="text-white bg-black-700 hover:bg-black-800 focus:ring-4 focus:outline-none hover:bg-gray-700 hover:text-white' focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-sky-500 dark:focus:ring-sky-600"
					>
						<svg
							aria-hidden="true"
          ...
          <div class="pt-2">
            <button
              @click="loginUser()"
              type="button"
              class="pt-2 text-white bg-sky-500 hover:bg-sky-600 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-sky-500 focus:outline-none dark:focus:ring-sky-600"
            >
              Log In
            </button>
          </div>
